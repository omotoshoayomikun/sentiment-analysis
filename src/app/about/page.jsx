  ...
  return (
    <>
      ...
      <div className="sidePadding mt-8">
        <div className="">
          <h1 className="text-[30px] font-bold leading-[3.5rem] text-[var(--s-blue-dark)]">About Us </h1>
          <p className="text-[var(--s-blue)]">
        ...
        <div className="">
          <h1 className="text-[30px] font-bold leading-[3.5rem] text-[var(--s-blue-dark)]">
            Our Mission
          </h1>
          <p className="text-[var(--s-blue)]">
